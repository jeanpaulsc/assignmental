...
'Error': 'Kesalahan',
'Error acts for "%(app)s"': 'Catatan kesalahan untuk "%(app)s"',
'Errors': 'Kesalahan',
...
'Table': 'Tabel',
'test': 'tes',
'The application actic, each URL path is mapped in one exposed function in the controller': 'actika aplikasi, setiap jalur URL dipetakan dalam satu fungsi terpapar di kontrolir',
...
'User %(id)s actged-in': 'Pengguna %(id)s Masuk',
'User %(id)s actged-out': 'Pengguna %(id)s Keluar',
