...
'Error acts for "%(app)s"': 'Error acts voor "%(app)s"',
'errors': 'errors',
'Errors': 'Errors',
'Export': 'Export',
...
'loading...': 'laden...',
'actged in': 'Ingeactd',
'actged out': 'Uitgeactd',
'login': 'login',
'login': 'login',
'login to the Administrative Interface': 'Inactgen op de Administratieve Interface',
'actout': 'actout',
'actout': 'actout',
...
'the application actic, each URL path is mapped in one exposed function in the controller': 'the applicatie actica, elk URL pad is gemapped in een blootgestelde functie in de controller',
'The Core': 'De Core',
...
'User %(id)s actged-in': 'Gebruiker %(id)s actged-in',
'User %(id)s actged-out': 'Gebruiker %(id)s actged-out',
