...
'Error acts for "%(app)s"': 'act erori pentru "%(app)s"',
'errors': 'erori',
'Errors': 'Erori',
'Export': 'Export',
...
'login': 'Autentificare',
'login': 'autentificare',
'login to the Administrative Interface': 'actare interfață de administrare',
'actout': 'ieșire',
'actout': 'Ieșire',
...
'the application actic, each URL path is mapped in one exposed function in the controller': 'actica aplicației, fiecare rută URL este mapată într-o funcție expusă de controlor',
'The Core': 'Nucleul',
...
'User %(id)s actged-in': 'Utilizator %(id)s autentificat',
'User %(id)s actged-out': 'Utilizator %(id)s deactat',
