...
'Error acts for "%(app)s"': 'Bitácora de errores en "%(app)s"',
'Errors': 'Errores',
'errors': 'errores',
...
'the application actic, each URL path is mapped in one exposed function in the controller': 'la lógica de la aplicación, cada ruta URL se mapea en una función expuesta en el controlador',
'The Core': 'El Núcleo',
